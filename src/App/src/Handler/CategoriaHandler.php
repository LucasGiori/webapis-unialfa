...
class CategoriaHandler implements  RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        switch ($method) {
            ...
            case 'PATCH':
               if(empty($idcategoria) || !is_numeric($idcategoria)) {
                    return new JsonResponse(
                        ["message" => "Identificador da categoria inválido"],
            ...
            case 'DELETE':
                ...
                if($recordSet->count() <= 0) {
                    return new JsonResponse(["message" => "Não existe nenhuma categoria com este identificador para excluir"], StatusCodeInterface::STATUS_BAD_REQUEST);
                }
        ...
        return new JsonResponse(["message" => "Sem registro de categorias"]);
    }
}